...
if (!class_exists('PCS_CUSTOM_SETTING')) {
    ...
    class PCS_CUSTOM_SETTING
    {
        ...
        function custom_taxonomy_industry_team() {
            ...
            register_taxonomy('industry_team', array('attorney','post','video','alert','publication'), $args);
        }
        ...
        function custom_search_ajax_callback() {
            ...
            if (empty($search_query) && empty($practice_area) && empty($industry_team) && empty($market_focus) && empty($office) && empty($title) && empty($select_letter) ) {
                $args = array(
                    'post_type' => 'attorney', // Change to your custom post type name
            ...
            } elseif (!empty($search_query) && empty($practice_area) && empty($industry_team) && empty($market_focus) && empty($office) && empty($title) && empty($select_letter) ) {
                $args = array(
                    'post_type' => 'attorney', // Change to your custom post type name
                    's' => $search_query,
                    'posts_per_page' => -1, // Show all posts
            ...
            } elseif (!empty($select_letter) && empty($practice_area) && empty($industry_team) && empty($market_focus) && empty($office) && empty($title) && empty($search_query) ) {
                $args = array(
                'post_type' => 'attorney',
                'posts_per_page' => -1,
                'post_status' => array('publish'),
